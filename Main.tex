...
\begin{frame}{Background}
    ...
    \begin{tabu}{*5{X[l,-1]}}
      \includegraphics[height=1.5cm]{Figures/Introduction/Fig1.png} &
      \includegraphics[height=1.5cm]{Figures/Introduction/Fig2.png} &
      \includegraphics[height=1.5cm]{Figures/Introduction/Fig3.png} &
      \includegraphics[height=1.5cm]{Figures/Introduction/Fig4.png} &
      \includegraphics[height=1.5cm]{Figures/Introduction/Fig5.png}
    \end{tabu}
