...
%        \begin{wrapfigure}[122]{L}{0.5\textwidth}
%            \centering
%            \vspace{-\baselineskip}
...
%    \begin{window}[0,l,{\includeslide[width = 0.5\textwidth]{#1}},{}]
%        #2
%    \end{window}\vfill
...
%    \end{itemize}
    ...
    The figure shows that with the development of industrial control systems, the degree of automation is increasing. 
}
